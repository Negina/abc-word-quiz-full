let songs = [
...

    {
        ...
        src: "as-starter/audio/close.mp3",
        options: [
    ...
    {
        title: "listen",
        src: "as-starter/audio/listen.mp3",
        options: [
            {name: "look", src: "../../img/look.png", correct: false},
    ...
    {
        title: "stand up",
        src: "as-starter/audio/stand.mp3",
        options: [
